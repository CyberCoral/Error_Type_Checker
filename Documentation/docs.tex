...
\begin{document}
	...
	\lstinputlisting[firstline=109,lastline=172]{Automated_Error_Checks.py}
	\newpage
	...
	\lstinputlisting[firstline=177,lastline=193]{Automated_Error_Checks.py}
	...
	\lstinputlisting[firstline=193,lastline=224]{Automated_Error_Checks.py}
 	...
 	\lstinputlisting[firstline=224,lastline=263]{Automated_Error_Checks.py}
